...
# Sensor-only finetune entry point for TinyLLaMA-based TinyLLaVA checkpoints.

DEFAULT_SENSOR_DATA_PATH="/home/sihsch/tiny-LLaVA/dataset/sensor/combined_dataset_1.6_ft.json"
DEFAULT_LLM_VERSION="TinyLlama/TinyLlama-1.1B-Chat-v1.0"
DEFAULT_VT_VERSION="google/siglip-so400m-patch14-384"
DEFAULT_CN_VERSION="mlp2x_gelu"
DEFAULT_PRETRAINED_MODEL_PATH="/home/sihsch/tiny-LLaVA/checkpoints/llava_factory/tiny-llava-TinyLlama-1.1B-Chat-v1.0-siglip-so400m-patch14-384-base-pretrain"
