...
# Sensor-only finetune entry point for Qwen2-based TinyLLaVA checkpoints.

DEFAULT_SENSOR_DATA_PATH="/home/sihsch/tiny-LLaVA/dataset/sensor/combined_dataset_1.6_ft.json"
DEFAULT_LLM_VERSION="Qwen/Qwen2.5-3B"
DEFAULT_VT_VERSION="google/siglip-so400m-patch14-384"
DEFAULT_CN_VERSION="mlp2x_gelu"
DEFAULT_PRETRAINED_MODEL_PATH="/home/sihsch/tiny-LLaVA/checkpoints/llava_factory/tiny-llava-Qwen2.5-3B-siglip-so400m-patch14-384-qwen2-0_5b_base-pretrain"
...
OUTPUT_DIR="/home/sihsch/tiny-LLaVA/checkpoints/llava_factory/tiny-llava-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-sensor-finetune"
...
deepspeed --num_gpus $NUM_GPUS --master_port $MASTER_PORT tinyllava/train/train.py \
    ...
    --fp16 True \
    --tokenizer_name_or_path $LLM_VERSION \
